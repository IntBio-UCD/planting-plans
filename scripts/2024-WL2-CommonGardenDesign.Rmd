...
## IMPORTANT
 Snaking blocks through the beds really should be done but it is trick to coordinate with the blocked positions from the field.
 ...
 in the correct order.  Didn't happen for 2024.
...
# Note: the above really should be done but it is trick to coordinate with the blocked positions from the field.
# Probably need a new strategy of adding "germinated" plants to the plan.  Like arrange the plan3 df in
# the correct order with the snaking, and then pull in the germinated plants, possible one at a time to fill it up 
# in the correct order.  Didn't happen for 2024.
